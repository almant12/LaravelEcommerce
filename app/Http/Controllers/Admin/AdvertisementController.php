...
class AdvertisementController extends Controller{
    ...
    public function homepageBannerSectionOne(Request $request){
        ...
        $imagePath = $this->updateImage($request,'banner_image');
    ...
    public function homepageSectionBannerTwo(Request $request){
        ...
        $imagePath = $this->updateImage($request,'banner_one_image');
        $imagePathTwo = $this->updateImage($request,'banner_two_image');
    ...
    public function homepageBannerSectionThree(Request $request)
    {
        ...
        $imagePath = $this->updateImage($request, 'banner_one_image');
        $imagePathTwo = $this->updateImage($request, 'banner_two_image');
        $imagePathThree = $this->updateImage($request, 'banner_three_image');
