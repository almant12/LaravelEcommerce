...
use App\Models\AdminVendorRequest;
...
class AdminVendorRequestDataTable extends DataTable
{
    /**
    ...
    {
        return $this->builder()
                    ->setTableId('adminvendorrequest-table')
    ...
    {
        return 'AdminVendorRequest_' . date('YmdHis');
    }
}
