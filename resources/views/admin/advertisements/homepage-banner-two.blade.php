    ...
    <div class="card border">
        <div class="card-body">
            <form action="{{route('admin.homepage-banner-section-two')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <img src="{{asset(@$homepage_section_banner_two->banner_one->banner_image)}}" alt="" width="150px">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <img src="{{asset(@$homepage_section_banner_two->banner_two->banner_image)}}" alt="" width="150px">
                </div>
                <div class="form-group">
