                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <div class="tab-content" id="nav-tabContent">
                                        ...
                                        @include('admin.advertisements.homepage-banner-three')

                                        @include('admin.advertisements.homepage-banner-four')

                                        @include('admin.advertisements.product-page-banner')

                                        @include('admin.advertisements.cart-page-banner')
