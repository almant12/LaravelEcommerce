            ...
            <div class="col-xl-9 col-lg-8">
                <div class="row">
                        ...
                        <div class="wsus__product_topbar">
                            <div class="wsus__product_topbar_left">
                                <div class="nav nav-pills" id="v-pills-tab" role="tablist"
                                    ...
                                    <button class="nav-link list-view {{session()->has('product_list_style') && session()->get('product_list_style') == 'grid' ? 'active' : ''}} {{!session()->has('product_list_style') ? 'active' : ''}}" id="v-pills-home-tab" data-id="grid" data-bs-toggle="pill"
                                            data-bs-target="#v-pills-home" type="button" role="tab"
                                            aria-controls="v-pills-home" aria-selected="true">
                                        <i class="fas fa-th"></i>
                                    </button>
                                    <button class="nav-link list-view {{session()->has('product_list_style') && session()->get('product_list_style') == 'list' ? 'active' : ''}}" id="v-pills-profile-tab" data-id="list" data-bs-toggle="pill"
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        {{!session()->has('product_list_style') ? 'show active' : ''}}" id="v-pills-home" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                -{{calculateDiscountPercent($product->price,$product->offer_price)}}%</span>
                                            ...
                                            <a class="wsus__pro_link" href="{{route('product-detail',$product->slug)}}">
                                                ...
                                                @if(isset($product->imagesGallery[0]->image))
                                                    <img src="{{asset($product->imagesGallery[0]->image)}}" alt="product" class="img-fluid w-100 img_2" />
                                                @else
                                    ...
                                    <div class="col-xl-12">
                                        <div class="wsus__product_item wsus__list_view">
                                            ...
                                            <a class="wsus__pro_link" href="{{route('product-detail', $product->slug)}}">
                                                ...
                                                <img src="
                                                @if(isset($product->imagesGallery[0]->image))
                                                    {{asset($product->imagesGallery[0]->image)}}
                                                @else
                                            ...
                                            <div class="wsus__product_details">
                                                ...
                                                @if(chackDiscount($product))
                                                    <p class="wsus__price">{{priceFormat($product->offer_price)}} {{$settings->currency_icon}}
                                                        <del>{{priceFormat($product->price)}} {{$settings->currency_icon}}</del></p>
                                                @else
                                                    <p class="wsus__price">{{priceFormat($product->price)}} {{$settings->currency_icon}}</p>
                                                @endif
                                                ...
                                                <ul class="wsus__single_pro_icon">
                                                    <form action="" class="shopping-cart-form">
                                                        ...
                                                        @foreach($product->productVariants as $variant)
                                                            @if($variant->status != 0)
                                                                <select class="d-none" name="variants_items[]">
                                                                    <option {{$variant->is_default == 1 ? 'selected' : ''}} value="{{$variant->id}}">
                                                                    </option>
                                                                </select>
                                                            @endif
                                                        @endforeach
