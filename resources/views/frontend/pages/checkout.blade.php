                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="wsus__order_details" id="sticky_sidebar">
                                ...
                                @if ($method->type === 'min_cost' && getCartTotal() >= $method->min_cost)
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="exampleRadios1">
                                            {{$method->name}}
                                            <span>cost: ({{priceFormat($method->cost)}}{{$settings->currency_icon}})</span>
                                        </label>
                                    </div>
                            ...
                            <div class="wsus__order_details_summery">
                                ...
                                @endif
                                <p><b>total:</b> <span><b id="total_amount" data-id="{{getMainCartTotal()}}">{{priceFormat(getMainCartTotal())}}{{$settings->currency_icon}}</b></span></p>
                            </div>
                            <div class="terms_area">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="flexCheckChecked3">
                                        I have read and agree to the website <a href="{{ route('terms-and-condition.index') }}">terms and conditions *</a>
                                    </label>
                                </div>
                            </div>
                            ...
                            <a id="submitCheckoutForm" class="common_btn">Place Order</a>
                        </div>
                    </div>
                </div>
        </div>
    ...
    <script>
        $(document).ready(function (){
            ...
            $('.shipping_method').on('click',function (){
                ...
                $('#shipping_fee').text(Number(shippingFee).toLocaleString(undefined,{minimumFractionDigits:0}) + "{{$settings->currency_icon}}")
                $('#total_amount').text(Number(totalAmount).toLocaleString(undefined,{minimumFractionDigits:0}) + "{{$settings->currency_icon}}")
            })
