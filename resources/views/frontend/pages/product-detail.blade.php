                            ...
                            <div class="exzoom hidden" id="exzoom">
                                <div class="exzoom_img_box">
                                    ...
                                    <ul class='exzoom_img_ul'>
                                        ...
                                        @foreach($product->imageGalleries as $productImage)
                                                        ...
                                                        <div class="wsus__comment_area">
                                                            ...
                                                            <div class="wsus__main_comment">
                                                                ...
                                                                <div class="wsus__comment_text reply">
                                                                    ...
                                                                    <span>{{date('d M Y h:i A',strtotime($review->created_at))}}</span>
                                                                    <p>{{$review->review}}</p>
                                                                    <ul class="">
                                                        ...
                                                        @if($isBrought === true)
                                                            <div class="wsus__post_comment rev_mar" id="sticky_sidebar3">
                                                                ...
                                                                <form action="{{route('user.product-review.create')}}" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <input class="star_input" type="hidden" name="rating">
...
@push('scripts')
    ...
    <script>
        ...
        const startInput = document.querySelector('.star_input');
