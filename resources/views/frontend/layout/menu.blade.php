            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus__menu_item">
                        ...
                        <li><a class="{{setActive(['about.index'])}}" href="{{route('about.index')}}">about</a></li>
                    ...
                    <ul class="wsus__menu_item wsus__menu_item_right">
                        ...
                        <li><a href="{{ route('admin.dashboar') }}">Admin Dashboard</a></li>
                        @endif
                        @else
            ...
            <div class="wsus__mobile_menu_main_menu">
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <ul class="wsus_mobile_menu_category">
                        ...
                        <li>
                            <a href="{{route('products.index',['category'=>$categoryItem->slug])}}" class="{{count($categoryItem->subCategories) > 0 ? 'accordion-button' : ''}} collapsed" data-bs-toggle="collapse"
